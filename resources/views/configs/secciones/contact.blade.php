                ...
                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-9 col-sm-12 col-xs-12 col-12 mx-auto py-5 position-relative">
                    <div class="row">
                        ...
                        <div class="col-xxl-9 col-xl-9 col-lg-9 col-md-11 col-sm-11 col-xs-11 col-11 py-1">
                            <textarea class="form-control bg-transparent text-start editarajax m-0" id="" rows="5" name="texto" data-id="{{ $elements[27]->id }}" data-table="Elemento" data-campo="texto" style="line-height: 1; color: #44B2E5;">{{ $elements[27]->texto }}</textarea>   
                        </div>
                    </div>
                    <div class="row mt-5">
                    ...
                    <div class="row mt-4">
                        <div class="col position-relative">
                            ...
                            <div class="col d-flex justify-content-center align-items-center flex-column position-absolute top-0 bottom-0 start-0 cuadro">
                                <a href="{{ route('config.contact') }}" class="btn btn-outline bg-white">Presiona este boton para editar</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <form action="vendor/Correos/mail.php" method="POST">
                        <div class="row mt-2">
                            <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 col-12 mx-auto py-2">
                                <input type="text" name="nombre" class="form-control" placeholder="Nombre" style="border: 2px solid #44B2E5; box-shadow: none;"> 
                            </div>
                            <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 col-12 mx-auto py-2">
                                <input type="text" name="empresa" class="form-control" placeholder="Empresa" style="border: 2px solid #44B2E5; box-shadow: none;">
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 col-12 mx-auto py-2">
                        ...
                        <div class="row mt-2">
                            <div class="col py-3">
                                <textarea name="mensaje" id="" cols="30" rows="4" class="form-control" placeholder="Mensaje" style="border: 2px solid #44B2E5; box-shadow: none;"></textarea>
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6 col-sm-12 col-xs-12 col-12 mx-xxl-0 mx-xl-0 mx-lg-0 mx-md-auto mx-sm-0 mx-xs-0 mx-0 py-2">
                                <input type="submit" class="form-control bg-white" style="border: 2px dashed #44B2E5; border-radius: 16px; color: #1E4A89;">
                            </div>
                        </div>
                    </form>
                    <div class="col d-flex justify-content-center align-items-center flex-column position-absolute top-0 bottom-0 start-0 cuadro">
