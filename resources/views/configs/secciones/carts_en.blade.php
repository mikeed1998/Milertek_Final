...
<div class="row mb-4 px-2">
    ...
    <div class="col-3 text-center">
        <a href="/admin/config/secciones/carts_en" class="col col-md-2  darken-2 text-white mr-auto"><img src="{{ asset('img/design/inicio/usa.png') }}" alt=""></a>
        <a href="/admin/config/secciones/carts" class="col col-md-2  darken-2 text-white mr-auto"><img src="{{ asset('img/design/inicio/mexico.png') }}" alt=""></a>
    </div>
</div>
{{-- {{ ($leng == 'eng') ? '' : '' }} --}}
    <div class="container mt-5 mb-5 pt-5">
        ...
        <div class="row">
            <div class="col">
                <div class="container">
                    <h2>Shopping filter</h2>
                    <p>Enter some relevant information about a purchase made</p>  
                                                        ...
                                                        <div class="col-2 fs-5">
                                                            ...
                                                            @endif --}}
                                                                ...
                                                                <form action="{{ route('config.seccion.check', ['order' => $order->id]) }}" method="POST" id="fromuact-{{ $order->id }}">
                                                                    ...
                                                                    <input type="submit" class="btn btn-sm btn-danger" value="Undelivered">
                                                                </form>
                                                                @else
                                                                <form action="{{ route('config.seccion.check', ['order' => $order->id]) }}" method="POST" id="fromudeact-{{ $order->id }}">
                                                                    ...
                                                                    <input type="submit" class="btn btn-sm btn-success" value="Delivered">
                                                                </form>
                                                                @endif
                                            ...
                                            <div class="accordion-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-3 border fw-bolder">
                                                        Total paid: {{ $order->cart->totalPrice }}
                                                    </div>
                                                </div>
