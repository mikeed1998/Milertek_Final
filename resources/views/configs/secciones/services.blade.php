						...
						<div class="col px-0 position-relative">
							...
							">
								<form id="form_imagen-statics" action="imgStatic" method="POST"  class="file-upload mt-2" style="" enctype="multipart/form-data">
                                    ...
                                    <label class="col-12 m-0 p-2 d-flex justify-content-center align-items-center" for="input_imagen-statics" style="opacity: 100%; border-radius: 26px; background-color: #44B2E3;">Seleccionar archivo</label>
								</form>
							</div>
										...
										<div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
											<div class="row">
												<div class="col display-1 scroll-1 text-white" style="overflow: auto; max-height: 90px;">
													<textarea class="form-control fs-1 fw-bolder text-white bg-transparent editarajax m-0" id="" rows="1" name="texto" data-id="{{ $elements[9]->id }}" data-table="Elemento" data-campo="texto">{{ $elements[9]->texto }}</textarea>  
												</div>
											</div>
											<div class="row mt-3">
												<div class="col text-white scroll-1" style="overflow: auto; max-height: 70px;">
													<textarea class="form-control text-white bg-transparent editarajax m-0" id="" rows="6" name="texto" data-id="{{ $elements[10]->id }}" data-table="Elemento" data-campo="texto">{{ $elements[10]->texto }}</textarea> 
												</div>
											</div>
										</div>
									</div>
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<form action="{{ route('config.seccion.servicioSide') }}" method="POST"  enctype="multipart/form-data">
								...
								<div class="row form-group">
									<div class="col">
										<label for="descripcion">Descripción del servicio [ES]</label>
										<textarea name="descripcion" class="form-control" id="" cols="30" rows="8" placeholder="Descripción del servicio" required></textarea>
									</div>
								</div>
								<div class="row form-group">
									<div class="col">
										<label for="nombre_en">Nombre [EN]</label>
										<input type="text" name="nombre_en" class="form-control" placeholder="Nombre (Ingles)" required> 
									</div>
								</div>
								<div class="row form-group">
									<div class="col">
										<label for="descripcion_en">Descripción del servicio [EN]</label>
										<textarea name="descripcion_en" class="form-control" id="" cols="30" rows="8" placeholder="Descripción (Ingles)" required></textarea>
									</div>
								</div>
								<div class="row form-group border py-3">
									<div class="col-12 text-center">
										<label for="imagen_servicio" class="fs-5">Imagen del servicio</label>
									</div>
								...
								<div class="row form-group">
									<div class="col-6 mx-auto text-center">
										<input type="submit" class="btn btn-outline border" value="Crear nuevo servicio">
									</div>
								</div>
							</form>
						</div>
							...
							<div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-12 col-xs-12 col-12 rounded-start">
								...
								">
									<form action="{{ route('config.seccion.imgServicio', [$serv->id]) }}" method="POST" enctype="multipart/form-data">
										...
										<input type="submit" class="col-12 m-0 p-2 form-control d-flex justify-content-center align-items-center grande" style="opacity: 100%; border-radius: 26px; background-color: #44B2E3;" value="Cambiar imagen">
									</form>
								</div>
							</div>
											...
											<div class="row">
												<div class="col-xxl-11 col-xl-11 col-lg-12 col-md-12 col-sm-12 col-xs-12">
													<h5 class="card-title">
														...
														<textarea class="form-control fs-3 bg-transparent editarajax m-0" id="" rows="1" name="texto" data-id="{{ $serv->id }}" data-table="MServicios" data-campo="nombre" style="color: #1E4A89;">{{ $serv->nombre }}</textarea> 
													</h5>
													<p class="card-text-servicio m-0 scroll-1" style="font-size: 14px; color: black;">
													
														<textarea class="form-control bg-transparent editarajax m-0" id="" rows="6" name="texto" data-id="{{ $serv->id }}" data-table="MServicios" data-campo="descripcion" style="line-height: 1;">{{ $serv->descripcion }}</textarea> 
													</p>
													<p class="card-text">
														<div class="row">
