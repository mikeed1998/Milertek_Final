                                                            ...
                                                            <div class="col-4 d-flex align-items-center">
                                                                ...
                                                                <div class="modal fade" id="staticBackdropg{{ $pd->id }}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                                    <div class="modal-dialog modal-lg">
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <h1 class="modal-title fs-5" id="staticBackdropLabel">Galeria de fotos del producto</h1>
                                                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                                            </div>
                                                                            <div class="modal-body">
                                                                                <div class="row py-5">
                                                                                    <div class="col">
                                                                                        ...
                                                                                        @else
                                                                                            <h2>No hay imagenes en la galeria</h2>
                                                                                        @endif
                                                                                    </div>
                                                                                </div>
                                                                                <div class="row">
                                                                                    <div class="col">
                                                                                        <form action="{{ route('config.seccion.productoUpdate', ['producto' => $pd->id]) }}" id="formug-{{ $pd->id }}" method="POST"  enctype="multipart/form-data">
                                                                                            ...
                                                                                            <div class="row form-group">
                                                                                                <div class="col-6 mx-auto text-center">
                                                                                                    <input type="submit" class="btn btn-outline border" value="Insertar foto en la galeria">
                                                                                                </div>
                                                                                            </div>
                                                                                        </form>
                                                                                    </div>
