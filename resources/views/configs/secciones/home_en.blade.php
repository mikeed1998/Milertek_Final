                    ...
                    <div class="row">
                        <div class="col">
                            <div class="col-12 d-flex justify-content-center align-items-center flex-column mt-2 text-center">
                                <h3 class="fs-1 fw-bolder" style="color:white; font-family: Arial, sans-serif;">Add slider</h3>
                                <form id="form_image_slider" action="imgSider" method="POST"  class="file-upload mt-2" style="" enctype="multipart/form-data">
                                    ...
                                    <label class="col-12 m-0 p-2 d-flex justify-content-center align-items-center" for="input_slider_img" style="opacity: 100%; !important; border-radius: 26px; background-color: #44B2E3;">Select file</label>
                                </form>
                            </div>
                        </div>
                    </div>
                                                        ...
                                                        <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12 ">
                                                            <div class="row">
                                                                <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-11 col-xs-11 col-11 position-relative mx-auto display-1 scroll-1 text-white" style="overflow: auto; max-height: 90px;">
                                                                    <textarea class="form-control fs-2 fw-bolder text-white bg-transparent text-start editarajax m-0 titulo" id="aux" rows="1" name="texto" data-id="{{ $sp->id }}" data-table="MSliderPrincipal" data-campo="titulo_en"> {{ $sp->titulo_en }} </textarea>
                                                                </div>
                                                            </div>
                                                            <div class="row mt-3">
                                                                <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-11 col-xs-11 col-11 mx-auto text-white scroll-1" style="overflow: auto; max-height: 70px;">
                                                                    ...
                                                                    <textarea class="form-control fw-bolder text-white bg-transparent text-start editarajax m-0" id="" rows="3" name="texto" data-id="{{ $sp->id }}" data-table="MSliderPrincipal" data-campo="descripcion_en"> {{ $sp->descripcion_en }} </textarea>  
    ...
    <div class="row">
        <div class="col position-relative">
            ...
            <div class="col d-flex justify-content-center align-items-center flex-column position-absolute top-0 bottom-0 start-0 cuadro">
                <a href="{{ route('config.seccion.show', ['slug' => 'products']) }}" class="btn btn-outline bg-white">Edit from the "Products" section</a>
            </div>
        </div>
                ...
                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-9 col-sm-12 col-xs-12 mx-auto">
                    ...
                    <div class="row">
                        <div class="col-xxl-6 col-xl-6 col-lg-8 col-md-12 col-sm-12 col-xs-12" >
                            <textarea class="form-control bg-transparent editarajax m-0" id="" rows="5" name="texto" data-id="{{ $elements[28]->id }}" data-table="Elemento" data-campo="texto" style="color: #44B2E3; line-height: 1.2;">{{ $elements[28]->texto }}</textarea>   
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12 px-0 py-5">
                            ...
                            ">
                                <form id="form_imagen-static" action="imgStatic" method="POST"  class="file-upload mt-2" style="" enctype="multipart/form-data">
                                    ...
                                    <label class="col-12 m-0 p-2 d-flex justify-content-center align-items-center" for="input_imagen-static" style="opacity: 100%; border-radius: 26px; background-color: #44B2E3;">choose file</label>
                                </form>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-9 col-sm-12 col-xs-12 mx-auto">
                    <div class="row">
                        ...
                        <div class="col-xxl-9 col-xl-9 col-lg-10 col-md-12 col-sm-12 col-xs-12 position-relative px-0 text-end">
                            ...
                            <div class="col-6 mt-xxl-4 mt-xl-3 mt-lg-2 mt-md-1 mt-sm-0 mt-xs-0 position-absolute top-0 start-0">
                                <div class="row">
                                    <div class="col text-white display-5 text-center">
                    ...
                    <div class="row mt-5">
                        ...
                        <div class="col-xxl-8 col-xl-8 col-lg-9 col-md-9 col-sm-12 col-xs-12 py-5 text-white text-start" style="line-height: 1.2;">
                            <textarea class="form-control text-start text-white bg-transparent editarajax m-0" id="" rows="10" name="texto" data-id="{{ $elements[29]->id }}" data-table="Elemento" data-campo="texto">{{ $elements[29]->texto }}</textarea>   
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-4 col-sm-4 col-xs-4 col-5 px-4 fw-bolder text-white text-start">
                            <a href="nosotros.php" class="text-white" style="text-decoration: none;">
                                <p style="border-bottom: 5px solid #44B2E3;">See more</p>
                            </a>
    ...
    <div class="row">
        ...
        ">
            <form id="form_imagen-static2" action="imgStatic" method="POST"  class="file-upload mt-2" style="" enctype="multipart/form-data">
                ...
                <label class="col-12 m-0 p-2 d-flex justify-content-center align-items-center" for="input_imagen-static2" style="opacity: 100%; border-radius: 26px; background-color: #1E4A89;">choose file</label>
            </form>
        </div>
    </div>
    <div class="row">
            ...
            <div class="row">
                <div class="col-12 d-flex justify-content-center align-items-center flex-column mt-2 text-center">
                    ...
                    <form id="form_image_slider2" action="clientesSlider" method="POST"  class="file-upload mt-2" style="" enctype="multipart/form-data">
                        ...
                        <label class="col-12 m-0 p-2 d-flex justify-content-center align-items-center" for="input_slider_img2" style="opacity: 100%; !important; border-radius: 26px; background-color: #1E4A89;">Choose file</label>
                    </form>
                </div>
            </div>
        ...
        <div class="col position-relative" style="background-color: #1E4A89;">
            ...
            <div class="row mt-3">
                <div class="col-xxl-5 col-xl-5 col-lg-5 col-md-9 col-sm-12 col-xs-12 mx-auto text-center" style="color: #44B2E3;">
                    <textarea class="form-control text-start bg-transparent editarajax m-0" id="" rows="2" name="texto" data-id="{{ $elements[43]->id }}" data-table="Elemento" data-campo="texto" style="color: #44B2E3;">{{ $elements[43]->texto }}</textarea>  
                </div>
            </div>
                ...
                <div class="col-xxl-8 col-xl-10 col-lg-10 mx-auto">
                    <div class="row">
                        <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-9 col-sm-12 col-xs-12 py-xxl-0 py-xl-0 py-lg-0 py-md-2 py-sm-2 py-xs-2 py-2 mx-auto">
                            <input type="text" class="form-control input-mensaje" placeholder="Name" disabled>   
                        </div>
                        <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-9 col-sm-12 col-xs-12 py-xxl-0 py-xl-0 py-lg-0 py-md-2 py-sm-2 py-xs-2 py-2 mx-auto">
                        ...
                        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-9 col-sm-12 col-xs-12 py-xxl-0 py-xl-0 py-lg-0 py-md-2 py-sm-2 py-xs-2 py-2 mx-auto">
                            <input type="text" class="form-control input-mensaje" placeholder="Message" disabled>
                        </div>
                        <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-9 col-sm-12 col-xs-12 py-xxl-0 py-xl-0 py-lg-0 py-md-2 py-sm-2 py-xs-2 py-2 mx-auto">
                            <button class="btn w-100 btn-outline bg-white text-dark rounded" style="font-size: 13px;  font-weight: bold;" disabled>
                                <div style="color: #1E4A89;">Send</div>                                                                                                                                                                                                     
                            </button>
                        </div>
                    </div>
                </div>
            ...
            {{-- <div class="col d-flex justify-content-center align-items-center flex-column position-absolute top-0 bottom-0 start-0 cuadro">
                <a href="#/" class="btn btn-outline bg-white">Cannot be edited</a>
            </div> --}}
        </div>
    </div>
</div>
