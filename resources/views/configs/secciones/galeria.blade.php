...
@section('content')
	<div class="row mb-4 px-2">
		<a href="{{ route('config.seccion.show', ['slug' => 'products']) }}" class="col col-md-2 btn btn-sm grey darken-2 text-white mr-auto"><i class="fa fa-reply"></i> Regresar</a>
	</div>
    ...
    <div class="container-fluid mt-5 mb-5">
        ...
        <div class="row">
            <div class="col-12 d-flex justify-content-center align-items-center flex-column mt-2 text-center">
                <h3 class="fs-1 fw-bolder" style="color:black; font-family: Arial, sans-serif;">Agregar Nueva imágen/Add New image</h3>
                <form id="form_image_slider" action="{{ route('config.seccion.imgSiderGaleria') }}" method="POST"  class="file-upload mt-2" style="" enctype="multipart/form-data">
                    ...
                    <label class="col-12 m-0 p-2 d-flex justify-content-center align-items-center" for="input_slider_img" style="opacity: 100%; !important; border-radius: 26px; background-color: #44B2E3;">Agregar/Add</label>
                </form>
            </div>
        </div>
        {{-- <div class="row">
        ...
        <div class="row py-3">
            <div class="col fs-1 text-center">
                Galeria/Gallery: {{ $producto->nombre }}
            </div>
        </div>
        <div class="row">
                ...
                @if ($ga->producto == $producto->id)
                    <div class="col-3 py-3 position-relative">
                        <div class="card rounded">
                            <div class="card-body">
                                <img src="{{ asset('img2/photos/productos/galeria/'.$ga->foto) }}" alt="" class="img-fluid" style="width: 100%; height: 260px;">
                            </div>
                        </div>
