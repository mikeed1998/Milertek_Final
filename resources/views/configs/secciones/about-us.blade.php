                        ...
                        <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-9 col-sm-12 col-xs-12 col-12 fs-2 mx-auto fw-bolder py-5">
                            <div class="row">
                                <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-11 col-sm-11 col-xs-11 col-11 mt-5 mx-auto text-start">
                                    ...
                                    <textarea class="form-control fs-3 bg-transparent editarajax m-0" id="" rows="3" name="texto" data-id="{{ $elements[13]->id }}" data-table="Elemento" data-campo="texto" style="color: #3378C6;">{{ $elements[13]->texto }}</textarea> 
                        ...
                        <div class="col-xxl-9 col-xl-9 col-lg-8 col-md-9 col-sm-12 col-xs-12 col-12 mx-auto">
                            <div class="row">
                                <div class="col-11 mx-auto">
                                    <div class="row">
                                        <div class="col">
                                            <textarea class="form-control bg-transparent editarajax m-0" id="" rows="1" name="texto" data-id="{{ $elements[14]->id }}" data-table="Elemento" data-campo="texto" style="color: #1E4A89; font-size: 64px;">{{ $elements[14]->texto }}</textarea> 
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col py-4">
                                            
                                            <textarea class="form-control bg-transparent editarajax m-0" id="" rows="10" name="texto" data-id="{{ $elements[15]->id }}" data-table="Elemento" data-campo="texto">{{ $elements[15]->texto }}</textarea> 
            ...
            <div class="row">
                ...
                ">
                    <form id="form_imagen-staticn" action="imgStatic" method="POST"  class="file-upload mt-2" style="" enctype="multipart/form-data">
                        ...
                        <label class="col-12 m-0 p-2 d-flex justify-content-center align-items-center" for="input_imagen-staticn" style="opacity: 100%; border-radius: 26px; background-color: #1E4A89;">Cambiar imagen</label>
                    </form>
                </div>
            </div>
            <div class="row">
                <div class="col-6 mx-auto py-3 text-center display-3" style="color: #1E4A89;">
                    <textarea class="form-control bg-transparent text-center editarajax m-0" id="" rows="1" name="texto" data-id="{{ $elements[17]->id }}" data-table="Elemento" data-campo="texto" style="color: #1E4A89; font-size: 64px;">{{ $elements[17]->texto }}</textarea> 
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h1 class="modal-title fs-5" id="staticBackdropLabel">Nuevo</h1>
                                ...
                                <form action="{{ route('config.seccion.fechasSide') }}" method="POST"  enctype="multipart/form-data">
                                    ...
                                    <div class="row form-group">
                                        <div class="col">
                                            ...
                                            <input type="number" name="anio" min="1900" max="2100" class="form-control" placeholder="Ingresa el año" id="yearInput" required>
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col">
                                    ...
                                    <div class="row form-group">
                                        <div class="col-6 text-center mx-auto">
                                            <input type="submit" class="btn btn-outline border border-dark" value="Agregar nueva fecha">
                                        </div>
                                    </div>
                                </form>
                            </div>
                                ...
                                <div>
                                    <div class="col position-relative">
                                        <div class="card border-dark mb-3" style="max-width: 18rem;">
                                            ...
                                            <div class="card-body">
                                                <p class="card-text">
                                                    <textarea class="form-control bg-transparent fw-bolder text-start editarajax m-0" id="" rows="4" name="texto" data-id="{{ $fe->id }}" data-table="MFecha" data-campo="texto">{{ $fe->texto }}</textarea> 
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col position-relative text-center py-5">
                                            ...
                                            <div class="col position-absolute top-0 start-0">
                                                <form id="form_imagen-mission" action="imgStatic" method="POST"  class="file-upload mt-2" style="" enctype="multipart/form-data">
                                                    ...
                                                    <label class="col-12 m-0 p-2 d-flex justify-content-center align-items-center" for="input_imagen-mission" style="opacity: 100%; border-radius: 26px; background-color: #1E4A89;">Cambiar imagen</label>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xxl-7 col-xl-7 col-lg-6 col-md-6 col-sm-6 col-xs-6 col-12">
                                    <div class="row">
                                        <div class="col-11 mx-auto fs-3 mt-xxl-5 mt-xl-5 mt-lg-5 mt-md-5 mt-sm-5 mt-xs-5 mt-0 mb-1" style="color: #1E4A89;">
                                            <textarea class="form-control bg-transparent text-start editarajax m-0" id="" rows="1" name="texto" data-id="{{ $elements[19]->id }}" data-table="Elemento" data-campo="texto" style="color: #1E4A89; font-size: 24px;">{{ $elements[19]->texto }}</textarea> 
                                        </div>
                                    </div>
                                    <div class="row mb-xxl-0 mb-xl-0 mb-lg-0 mb-md-5 mb-sm-5 mb-xs-5 mb-5">
                                        <div class="col-11 mx-auto" style="line-height: 1;">
                                            <textarea class="form-control bg-transparent text-start editarajax m-0" id="" rows="5" name="texto" data-id="{{ $elements[20]->id }}" data-table="Elemento" data-campo="texto" style="line-height: 1;">{{ $elements[20]->texto }}</textarea> 
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xxl-5 col-xl-5 col-lg-8 col-md-9 col-sm-12 col-xs-12 col-12 mx-auto mt-5 bg-white">
                            <div class="row">
                                        ...
                                        <div class="col position-relative text-center py-5">
                                            ...
                                            <div class="col position-absolute top-0 start-0">
                                                <form id="form_imagen-vission" action="imgStatic" method="POST"  class="file-upload mt-2" style="" enctype="multipart/form-data">
                                                    ...
                                                    <label class="col-12 m-0 p-2 d-flex justify-content-center align-items-center" for="input_imagen-vission" style="opacity: 100%; border-radius: 26px; background-color: #1E4A89;">Cambiar imagen</label>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xxl-7 col-xl-7 col-lg-6 col-md-6 col-sm-6 col-xs-6 col-12">
                                    <div class="row">
                                        <div class="col-11 mx-auto fs-3 mt-xxl-5 mt-xl-5 mt-lg-5 mt-md-5 mt-sm-5 mt-xs-5 mt-0  mb-1" style="color: #1E4A89;">
                                            <textarea class="form-control bg-transparent text-start editarajax m-0" id="" rows="1" name="texto" data-id="{{ $elements[22]->id }}" data-table="Elemento" data-campo="texto" style="color: #1E4A89; font-size: 24px;">{{ $elements[22]->texto }}</textarea> 
                                        </div>
                                    </div>
                                    <div class="row mb-xxl-0 mb-xl-0 mb-lg-0 mb-md-5 mb-sm-5 mb-xs-5 mb-5">
                                        <div class="col-11 mx-auto" style="line-height: 1;">
                                            <textarea class="form-control bg-transparent text-start editarajax m-0" id="" rows="5" name="texto" data-id="{{ $elements[23]->id }}" data-table="Elemento" data-campo="texto" style="line-height: 1;">{{ $elements[23]->texto }}</textarea> 
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-xxl-7 col-xl-7 col-lg-6 col-md-6 col-sm-6 col-xs-6 col-12">
                                    <div class="row">
                                        <div class="col-11 mx-auto fs-2 mt-xxl-5 mt-xl-5 mt-lg-5 mt-md-5 mt-sm-5 mt-xs-5 mt-0 mb-1" style="color: #1E4A89;">
                                            <textarea class="form-control bg-transparent text-start editarajax m-0" id="" rows="1" name="texto" data-id="{{ $elements[25]->id }}" data-table="Elemento" data-campo="texto" style="color: #1E4A89; font-size: 24px;">{{ $elements[25]->texto }}</textarea> 
                                        </div>
                                    </div>
                                    <div class="row mb-xxl-0 mb-xl-0 mb-lg-0 mb-md-5 mb-sm-5 mb-xs-5 mb-5">
                                        <div class="col-11 mx-auto" style="line-height: 1;">
                                            <textarea class="form-control bg-transparent text-start editarajax m-0" id="" rows="5" name="texto" data-id="{{ $elements[26]->id }}" data-table="Elemento" data-campo="texto" style="line-height: 1;">{{ $elements[26]->texto }}</textarea>    
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="card border-0">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="col-12 text-center px-0"  style="line-height: 1; font-weight: 500;">
                                                <textarea class="form-control bg-transparent text-start editarajax m-0" id="" rows="4" name="texto" data-id="{{ $cer->id }}" data-table="MCertificacion" data-campo="descripcion" style="line-height: 1">{{ $cer->descripcion }}</textarea> 
                                            </div>
                                        </div>
                                    </div>
