                                                ...
                                                <li class="col-11 list-group-item border-0">
                                                    <div class="row">
                                                        <div class="col-6 fs-5">
                                                            @php
                                                                $link = '/admin/config/secciones/usuario_detalle/'.$order->id.'?leng=esp';
                                                            @endphp
                                                            ...
                                                            Usuario: {{ $order->name }} <a href="{{ $link }}" class="btn btn-outline border"><i class="fa fa-user"></i></a>
                                                        ...
                                                        <div class="col-2 fs-5">
                                                            ...
                                                            @endif --}}
                                                                ...
                                                                <form action="{{ route('config.seccion.check', ['order' => $order->id]) }}" method="POST" id="fromudeact-{{ $order->id }}">
                                                                    ...
                                                                    <input type="submit" class="btn btn-sm btn-success" value="Entregado">
                                                                </form>
                                                                @endif
