        ...
        <div class="col-xxl-3 col-xl-3 col-lg-12 col-md-11 col-sm-11 col-xs-11 col-11 mx-auto mt-3">
            <div class="row">
                ...
                <div class="col-xxl-9 col-xl-9 col-lg-9 col-md-9 col-sm-11 col-xs-11 mx-auto text-white" >
                    <textarea class="form-control text-white bg-transparent text-start editarajax m-0" id="" rows="5" name="texto" data-id="{{ $elements[30]->id }}" data-table="Elemento" data-campo="texto" style="line-height: 1.1;">{{ $elements[30]->texto }}</textarea>   
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                {{-- <div class="col-12 d-flex justify-content-center align-items-center flex-column mt-2 text-center">
                    <form id="form_image_slider3" action="categoriaSlider" method="POST"  class="file-upload mt-2" style="" enctype="multipart/form-data">
                        ...
                        <label class="col-12 m-0 p-2 d-flex justify-content-center align-items-center" for="input_slider_img3" style="opacity: 100% !important; background-color: #1E4A89; border-radius: 26px;">Add new category</label>
                    </form>
                </div> --}}
                        ...
                        <div class="modal-dialog modal-xl">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="staticBackdropLabel-categoria">New Category</h1>
                                ...
                                <div class="modal-body">
                                    <form action="{{ route('config.seccion.categoriaSlider') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            <div class="col">
                                                <label for="imagen_cate" class="fs-5">Category Icon</label>
                                                <br>
                                        ...
                                        <div class="form-group row">
                                            <div class="col">
                                                <input type="submit" class="btn btn-outline btn-primary" value="Create category">
                                            </div>
                                        </div>
                                    </form>
                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-8 col-sm-9 col-xs-9 col-8 p-4 text-white position-relative">
                                                    <strong class="texto-productos">
                                                        <textarea class="form-control text-white bg-transparent text-start editarajax m-0" id="" rows="1" name="texto" data-id="{{ $categoria->id }}" data-table="MCategorias" data-campo="categoria_en" style="line-height: 1.1; font-size: 14px;">{{ $categoria->categoria_en }}</textarea>   
                                                    </strong>
                                ...
                                <form action="{{ route('config.seccion.productoSide') }}" method="POST"  enctype="multipart/form-data">
                                    ...
                                    <div class="row form-group py-3">
                                        <div class="col-12 py-2">
                                            <label for="nombre" class="fs-5">Name [ES]</label>
                                            <input type="text" name="nombre" placeholder="Nombre del producto" class="form-control" required>
                                        </div>
                                        <div class="col-12 py-2">
                                            <label for="descripcion" class="fs-5">Description [ES]</label>
                                        ...
                                        <div class="col-4 mx-auto py-2">
                                            <label for="stock" class="fs-5">Stock</label>
                                            <input type="number" name="stock" placeholder="Products available" class="form-control" required>
                                        </div>
                                        <div class="col-4 mx-auto py-2">
                                            <label for="precio_mxn" class="fs-5">Equivalent (MXN)</label>
                                            <input type="number" name="precio_mxn" placeholder="Precio del producto" class="form-control" required>
                                        </div>
                                        <div class="col-4 mx-auto py-2">
                                            <label for="precio_usd" class="fs-5">Price (USD)</label>
                                            <input type="number" name="precio_usd" placeholder="Equivalente en dolares" class="form-control" required>
                                        </div>
                                    </div>
                                    <div class="row form-group py-3">
                                        <div class="col-12 text-center">
                                            <label for="ficha_tecnica" class="fs-5">Data sheet</label>
                                        </div>
                                        <div class="col text-center">
                                            <div class="file-select">
                                    ...
                                    <div class="row form-group border py-3">
                                        <div class="col-12 text-center">
                                            <label for="imagen_principal" class="fs-5">Image</label>
                                        </div>
                                        <div class="col text-center">
                                            <div class="file-select">
                                    ...
                                    <div class="row form-group border py-3">
                                        <div class="col-12 text-center">
                                            <label for="" class="fs-5">Characterístics</label>
                                        </div>
                                        <div class="col-9 text-center mx-auto">
                                            ...
                                            <button type="button" id="addInputButton" class="btn btn-outline border">Add another characteristic</button>
                                        </div>
                                    </div>
                                    <div class="row form-group border py-3">
                                            ...
                                            <select name="categoriaProducto" id="categoriaProducto" class="form-control">
                                                @if($categoriasCont != 0)
                                                    @foreach ($categorias as $categ)
                                                        <option value="{{ $categ->id }}">{{ $categ->categoria_en }}</option>
                                                    @endforeach
                                                @else
                                                    <option value="0">No categories avaible</option>
                                                @endif
                                            </select>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-11 py-3 mx-auto">
                                                <div class="row">
                                                    <div class="col-12 py-3 fw-bolder" >
                                                        <textarea class="form-control fw-bolder bg-transparent text-start editarajax m-0" id="" rows="1" name="nombre" data-id="{{ $pd->id }}" data-table="MProductos" data-campo="nombre_en" style="line-height: 1.1; font-size: 14px;">{{ $pd->nombre_en }}</textarea> 
                                                    </div>
                                                                            ...
                                                                            <div class="modal-body">
                                                                                <div class="row">
                                                                                    <div class="col-11 py-3 text-start mx-auto">
                                                                                        <label for="nombre" class="form-label text-start fs-5">Update name [ES]</label>
                                                                                ...
                                                                                <div class="row">
                                                                                    <div class="col-11 mx-auto text-start">
                                                                                        <label for="descripcion" class="form-label text-start fs-5">Update description [ES]</label>
                                                                                ...
                                                                                <div class="row">
                                                                                    <div class="col-11 py-3 text-start mx-auto">
                                                                                        <label for="nombre_en" class="form-label text-start fs-5">Update Name [EN]</label>
                                                                                ...
                                                                                <div class="row">
                                                                                    <div class="col-11 mx-auto text-start">
                                                                                        <label for="descripcion_en" class="form-label text-start fs-5">Update Description [EN]</label>
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-4 text-start mx-auto py-2">
                                                                                        <label class="fs-5">Update Stock</label>
                                                                                    ...
                                                                                    <div class="col-4 text-start mx-auto py-2">
                                                                                        <label class="fs-5">Equivalent (MXN)</label>
                                                                                    ...
                                                                                    <div class="col-4 text-start mx-auto py-2">
                                                                                        <label class="fs-5">Price (USD)</label>
                                                                                ...
                                                                                <div class="row border">
                                                                                    <div class="col-12 text-center py-3 fs-5">Update or delete characteristics</div>
                                                                                    ...
                                                                                    <form action="{{ route('config.seccion.caracteristicasSide', ['producto' => $pd->id]) }}" method="POST" enctype="multipart/form-data" class="myForm" id="fomuu-{{ $pd->id }}">
                                                                                        ...
                                                                                        <div class="row form-group py-3 mt-3">
                                                                                            <div class="col-12 text-center">
                                                                                                <label for="" class="fs-5">Add one or more characteristics</label>
                                                                                            </div>
                                                                                            <div class="col-9 text-center mx-auto">
                                                                                                ...
                                                                                                <button type="button" class="addInputButton btn border">Add another characteristic</button>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="row form-group">
                                                                                            <div class="col-6 mx-auto">
                                                                                                <input type="submit" value="Update new characteristics" class="form-control btn-secondary">
                                                                                            </div>
                                                                                        </div>
                                                                                    </form>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-9 mx-auto text-center display-5">
                                        There are no products available within this category.
                                    </div>
                                </div>
                            </div>
                        </div>
