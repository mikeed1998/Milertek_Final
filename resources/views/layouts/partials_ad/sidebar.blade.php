		...
		<ul class="custom-scrollbar" >
			...
			<li>
				<ul class="collapsible collapsible-accordion">
					...
					<li>
						<a href="{{ route('config.seccion.show', ['slug' => 'home_en']) }}" class="mx-3 my-1 collapsible-header waves-effect {{ (request()->is('admin/config/secciones/home_em')) ? 'active' : '' }}" style="border-radius: 16px;"><i class="fas fa-home"></i> Home (EN) </a>
					</li>
					<li>
						<a href="{{ route('config.seccion.show', ['slug' => 'products']) }}" class="mx-3 my-1 collapsible-header waves-effect {{ (request()->is('admin/config/secciones/products')) ? 'active' : '' }}" style="border-radius: 16px;"><i class="fab fa-servicestack"></i> Productos (ES) </a>
					</li>
					<li>
						<a href="{{ route('config.seccion.show', ['slug' => 'products_en']) }}" class="mx-3 my-1 collapsible-header waves-effect {{ (request()->is('admin/config/secciones/products_en')) ? 'active' : '' }}" style="border-radius: 16px;"><i class="fab fa-servicestack"></i> Products (EN) </a>
					</li>
					<li>
						<a href="{{ route('config.seccion.show', ['slug' => 'services']) }}" class="mx-3 my-1 collapsible-header waves-effect {{ (request()->is('admin/config/secciones/services')) ? 'active' : '' }}" style="border-radius: 16px;"><i class="fas fa-box-open"></i> Servicios (ES) </a>
					</li>
					<li>
						<a href="{{ route('config.seccion.show', ['slug' => 'services_en']) }}" class="mx-3 my-1 collapsible-header waves-effect {{ (request()->is('admin/config/secciones/services_en')) ? 'active' : '' }}" style="border-radius: 16px;"><i class="fas fa-box-open"></i> Services (EN) </a>
					</li>
					<li>
						<a href="{{ route('config.seccion.show', ['slug' => 'about-us']) }}" class="mx-3 my-1 collapsible-header waves-effect {{ (request()->is('admin/config/secciones/about-us')) ? 'active' : '' }}" style="border-radius: 16px;"><i class="fas fa-info"></i> Nosotros (ES) </a>
					</li>
					<li>
						<a href="{{ route('config.seccion.show', ['slug' => 'about-us_en']) }}" class="mx-3 my-1 collapsible-header waves-effect {{ (request()->is('admin/config/secciones/about-us_en')) ? 'active' : '' }}" style="border-radius: 16px;"><i class="fas fa-info"></i> About us (EN) </a>
					</li>
					<li>
						<a href="{{ route('config.seccion.show', ['slug' => 'contact']) }}" class="mx-3 my-1 collapsible-header waves-effect {{ (request()->is('admin/config/secciones/contact')) ? 'active' : '' }}" style="border-radius: 16px;"><i class="fas fa-mail-bulk"></i> Contacto (ES) </a>
					</li> 
					<li>
