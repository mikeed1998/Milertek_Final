                ...
                <div class="col-xxl-6 col-xl-6 col-lg-7 col-md-12 col-sm-12 col-xs-11 col-11 mx-xxl-0 mx-xl-0 mx-lg-0 mx-md-0 mx-sm-auto mx-xs-auto mx-auto py-xxl-4 py-xl-4 py-lg-4 py-md-0 py-sm-0 py-xs-0 px-xxl-0 px-xl-0 px-lg-0 px-md-0 px-sm-0 px-xs-3 px-3 bar1">
                    <div class="row fondo-bar-sm">
                        ...
                        <div class="col-xxl-9 col-xl-10 col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                            <div class="row">
                                <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-12 col-sm-12 col-xs-12 
                                    ...
                                    text-center 
                                    ">
                            <a href="{{ route('front.index') }}" style="text-decoration: none; font-size: 12px;" class="link-nav">
                                <p class="m-1 p-0" id="texto-inicio">{{ trans('inicio') }}</p>
                        ...
                        <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-12 col-sm-12 col-xs-12 
                                    ...
                                    text-center 
                                    ">
                            <a href="{{ route('front.productos') }}" style="text-decoration: none; font-size: 12px;" class="link-nav">
                                <p class="m-1 p-0" id="texto-productos">{{ trans('productos') }}</p>
                        ...
                        <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-12 col-sm-12 col-xs-12 
                                    ...
                                    text-center 
                                    ">
                            <a href="{{ route('front.servicios') }}" style="text-decoration: none; font-size: 12px;" class="link-nav">
                                <p class="m-1 p-0" id="texto-servicios">{{ trans('servicios') }}</p>
                        ...
                        <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-12 col-sm-12 col-xs-12                              
                                ...
                                text-center 
                                ">
                                <a href="{{ route('front.aboutus') }}" style="text-decoration: none; font-size: 12px;" class="link-nav">
                            <p class="m-1 p-0" id="texto-nosotros">{{ trans('nosotros') }}</p>
                                </a>
                        </div>
                        <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-12 col-sm-12 col-xs-12 
                                ...
                                {{-- <p class="m-1 p-0" id="texto-contacto">{{ trans('contacto') }}</p> --}}
                                <a href="{{ route('front.contacto') }}" style="text-decoration: none; font-size: 12px;" class="link-nav">
                                    CONTACTO
                                </a>
        ...
        <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-12 col-sm-12 col-xs-11 col-11 mx-xxl-0 mx-xl-0 mx-lg-0 mx-md-0 mx-sm-auto mx-xs-auto mx-auto py-xxl-3 py-xl-4 py-lg-4 py-md-0 py-sm-0 py-xs-0 px-xxl-0 px-xl-0 px-lg-0 px-md-0 px-sm-0 px-xs-3 px-3 bar2">
            <div class="row fondo-bar-sm">
                <div class="col-xxl-5 col-xl-3 col-lg-3 col-md-12 col-sm-12 col-xs-12 text-xxl-end text-xl-end text-lg-end text-md-center text-sm-center text-xs-center text-center py-1">
                            ...
                            <button type='button' class='btn btn-outline text-white' data-bs-toggle='modal' data-bs-target='#exampleModal'>
                ...
                <div class="col-xxl-2 col-xl-3 col-lg-3 col-md-12 col-sm-12 col-xs-12  text-center py-2">
    ...
    .boton-imagen img {
      ...
      object-fit: cover; /* Puedes usar otras opciones como "contain" o "fill" según tu preferencia */
                  ...
                  <div class="col-xxl-2 col-xl-3 col-lg-3 col-md-12 col-sm-12 col-xs-12  text-center py-1">
                      <a class="text-white " href="{{ route('front.index') }}"><img src="{{ asset('img/design/inicio/mx.png') }}" alt="" class="img-fluid"></a>
                      {{-- <button class="btn-idioma boton-imagen btn" data-idioma="es"><img src="{{ asset('img/design/inicio/mx.png') }}" alt="" class=""></button> --}}
                  </div>
                  <div class="col-xxl-2 col-xl-3 col-lg-3 col-md-12 col-sm-12 col-xs-12  text-center py-1">
                      <a class="text-white " href="{{ route('front.index', ['lang' => 'eng']) }}"><img src="{{ asset('img/design/inicio/usa.png') }}" alt="" class="img-fluid"></a>
...
<div class="container-fluid" style="display: none;">
    <div class="row">
        <div class="col">
            ...
            <button class="btn-idioma" data-idioma="es">Español</button>
            <button class="btn-idioma" data-idioma="en">English</button>

            <!-- Elementos para mostrar el texto -->
            <p id="texto-bienvenido">{{ trans('bienvenido') }}</p>
            <p id="texto-despedida">{{ trans('despedida') }}</p>
        </div> 
    </div>
</div> 
                    ...
                    <div class="row">
                        ...
                        <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-4 col-sm-4 col-xs-4 col-5 px-4 fw-bolder text-white text-start">
                            <a href="nosotros.php" class="text-white" style="text-decoration: none;">
                                <p style="border-bottom: 5px solid #44B2E3;" id="texto-vermas">{{ trans('vermas') }}</p>
                            </a>
                    ...
                    <form action="{{ route('formularioContac') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-9 col-sm-12 col-xs-12 py-xxl-0 py-xl-0 py-lg-0 py-md-2 py-sm-2 py-xs-2 py-2 mx-auto">
                                <input type="text" name="nombre" class="form-control input-mensaje" id="nombreform" placeholder="{{ ($lang == 'eng') ? "Name" : "Nombre" }}">   
                            </div>
                            <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-9 col-sm-12 col-xs-12 py-xxl-0 py-xl-0 py-lg-0 py-md-2 py-sm-2 py-xs-2 py-2 mx-auto">
                            ...
                            <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-9 col-sm-12 col-xs-12 py-xxl-0 py-xl-0 py-lg-0 py-md-2 py-sm-2 py-xs-2 py-2 mx-auto">
                                <input type="text" name="mensaje" class="form-control input-mensaje" id="mensajeform" placeholder="{{ ($lang == 'eng') ? "Message" : "Mensaje" }}">
                            </div>
                            <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-9 col-sm-12 col-xs-12 py-xxl-0 py-xl-0 py-lg-0 py-md-2 py-sm-2 py-xs-2 py-2 mx-auto">
                                <button class="btn w-100 btn-outline bg-white text-dark rounded" style="font-size: 13px;  font-weight: bold;">
                                    <div style="color: #1E4A89;"><p class="m-1 p-0" id="texto-enviarform">{{ ($lang == 'eng') ? "Send" : "Enviar" }}</p></div>                                                                                                                                                                                                     
                                </button>
                            </div>
                        </div>
                    </form>
...
{{-- <script>
    ...
    function actualizarContenido(data) {
        ...
        document.getElementById('texto-bienvenido').textContent = data.bienvenido;
        document.getElementById('texto-despedida').textContent = data.despedida;
        document.getElementById('texto-productos').textContent = data.productos;
        document.getElementById('texto-inicio').textContent = data.inicio;
        document.getElementById('texto-servicios').textContent = data.servicios;
        document.getElementById('texto-nosotros').textContent = data.nosotros;
        document.getElementById('texto-contacto').textContent = data.contacto;
        document.getElementById('texto-sectoresespeciaidad').textContent = data.sectoresespeciaidad;
        document.getElementById('texto-verproductos').textContent = data.verproductos;
        document.getElementById('texto-nosotros2').textContent = data.nosotros2;
        document.getElementById('texto-servicios2').textContent = data.servicios2;
        document.getElementById('texto-vermas').textContent = data.vermas;
        document.getElementById('texto-productos2').textContent = data.productos2;

        document.querySelectorAll('.texto-verpro').forEach(elemento => {
            elemento.textContent = data.verpro;
        });

        document.getElementById('texto-vertodo').textContent = data.vertodo;
        document.getElementById('texto-nuestrosclientes').textContent = data.nuestrosclientes;
        document.getElementById('texto-enviarmensaje').textContent = data.enviarmensaje;

        const inputNombre = document.getElementById('nombreform');
        inputNombre.placeholder = data.nombreform;

        const inputNombre2 = document.getElementById('mensajeform');
        inputNombre2.placeholder = data.mensajeform;

        document.getElementById('texto-enviarform').textContent = data.enviarform;
...
{{-- 
    ...
    "navConacto": "CONTACTO",
    "navPreguntasFrecuentes": "Peguntas Frecuentes",
    "footerTexto": "MILERTEK 2023 TODOS LOS DERECHOS RESERVADOS DISE&Ntilde;O DE WOZIAL"
     --}}
