        ...
        <div class="col-8 mx-auto" style="border: 3px solid red; border-radius: 36px;">
            <div class="row">
                ...
                <div class="col-12 text-center display-5" style="color: red;">
                    {{ ($leng == 'eng') ? 'Payment could not be processed' : 'El pago no pudo ser procesado' }}
                </div>
				<div class="col-12 mt-5">
                ...
                <div class="col-12 py-3 text-center">
                    <small class="fs-5">{{ ($leng == 'eng') ? 'Redirecting to your profile' : 'Redirigiendo a tu perfil' }}</small>
                </div>
            </div>
        </div>
    </div>
...
<script>
    setTimeout(function() {
        window.location.href = "{{ route('user.profile', ['leng' => $leng]) }}"; // Cambia 'nombre_de_la_ruta' por el nombre real de la ruta a la que deseas redirigir
