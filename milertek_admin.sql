...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-07-2023 a las 00:55:58
...
(2, 'texto ', NULL, NULL, NULL, 0, 1, 666, 1),
(3, 'aux2', NULL, NULL, NULL, 0, 1, 666, 2),
(4, 'aux3', NULL, NULL, NULL, 0, 1, 666, 4),
(5, 'aux', NULL, NULL, NULL, 0, 1, 666, 5),
(6, 'aux', NULL, NULL, NULL, 0, 1, 666, 6);
...
--
-- Estructura de tabla para la tabla `m_caracteristicas_productos`
--

CREATE TABLE `m_caracteristicas_productos` (
  `id` bigint(20) UNSIGNED NOT NULL,
...
--
-- Estructura de tabla para la tabla `m_certificaciones`
--

CREATE TABLE `m_certificaciones` (
  `id` bigint(20) UNSIGNED NOT NULL,
...
--
-- Indices de la tabla `m_caracteristicas_productos`
--
ALTER TABLE `m_caracteristicas_productos`
  ADD PRIMARY KEY (`id`);
...
--
-- Indices de la tabla `m_certificaciones`
--
ALTER TABLE `m_certificaciones`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de la tabla `m_caracteristicas_productos`
--
ALTER TABLE `m_caracteristicas_productos`
...
--
-- AUTO_INCREMENT de la tabla `m_certificaciones`
--
ALTER TABLE `m_certificaciones`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
